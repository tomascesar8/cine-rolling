                ...
                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                  ...
                  <br /> <br> Recorda ModoGamer nunca va a solicitarte esta u otra informacion sobre tu cuenta.<br />
                    ...
                    <td align="center" style="padding:0;">
                      <p style="margin: 0 0 20px 0; line-height: 1.2em;">
                        Hola <span style="font-weight:700">${capitalizeWords(
                          userRecovery.name
                        )}</span>, 
                  ...
                  <tr>
                    <td align="center" style="padding:40px 0 0 0;">                  
                      <p>Tu clave registrada es: <span style="background-color:#96cae7; color:#ffffff; padding: 10px; border-radius:20px">${
                        userRecovery.pass
                      }</span></p>
                    </td>
                  </tr>
